...
//#define HAVE_TMC2208
  ...
  #define R_SENSE           0.22  // R_sense resistor for EinsyRambo
  ...
  #define SENSORLESS_HOMING // TMC2130 only
    ...
    //Einsy Diag Pins - Must use as the MIN/MAX pins for sensorless endstop triggering to function.
    #define X_DIAG_PIN      64
    #define Y_DIAG_PIN      69
    #define Z_DIAG_PIN      68
    #define X_MIN_PIN X_DIAG_PIN
    //#define X_MAX_PIN X_DIAG_PIN   //Must set X_HOME_DIR  1
    #define Y_MIN_PIN Y_DIAG_PIN
    //#define Y_MAX_PIN Y_DIAG_PIN   //Must set Y_HOME_DIR  1
    //#define Z_MIN_PIN Z_DIAG_PIN
    //#define Z_MAX_PIN Z_DIAG_PIN   //Must set Z_HOME_DIR  1
  #endif
