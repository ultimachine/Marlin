...
/*****************************************************************
* UltiMachine Einy0.1-Einsy0.3 Pin Assignments
******************************************************************/
#if MB(EINY)
#define KNOWN_BOARD
#ifndef __AVR_ATmega2560__
...
#endif // UltiMachine Einy Rambo

/*****************************************************************
* UltiMachine Einsy 0.4 Pin Assignments
******************************************************************/
#if MB(EINSY)
#define KNOWN_BOARD
#ifndef __AVR_ATmega2560__
...
#define Y_DIR_PIN 48
#define X_MIN_PIN 12
#define X_MAX_PIN -1 //not on Einsy 1.0
#define X_ENABLE_PIN 29
#define X_MS1_PIN -1
#define X_MS2_PIN -1
#define X_TMC2130_CS 41
...
#define X_DIR_PIN 49
#define Y_MIN_PIN 11
#define Y_MAX_PIN -1 //not on Einsy 1.0
#define Y_ENABLE_PIN 28
#define Y_MS1_PIN -1
#define Y_MS2_PIN -1
#define Y_TMC2130_CS 39
...
#define Z_DIR_PIN 47
#define Z_MIN_PIN 10
#define Z_MAX_PIN -1 //not on Einsy 1.0
#define Z_ENABLE_PIN 27
#define Z_MS1_PIN -1
#define Z_MS2_PIN -1
#define Z_TMC2130_CS 67
...
#define SUICIDE_PIN        -1  //PIN that has to be turned on right after start, to keep power flowing.
  ...
  #define KILL_PIN          32
    ...
    #define BEEPER BEEPER_PIN
    #define LCD_PINS_RS     82
    #define LCD_PINS_ENABLE 61  // EINSY 0.4
    #define LCD_PINS_D4     59  // EINSY 0.4
    #define LCD_PINS_D5     70
    #define LCD_PINS_D6     85
    #define LCD_PINS_D7     71
