 ...
 * M44  - Unprotected write pin via gcode: M44 P<pin> S<value>
 * M45  - Read pin state: M45 <pin>
 * M47  - Analog read pin: M47 <pin>
 ...
 * M453 - LED Driver On (Controls LED Enable Pin) "M453 P<on-time-ms> S<off-time-ms>".
