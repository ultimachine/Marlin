...
void lcd_quick_feedback(const bool clear_buttons) {
   ...
   */
    ...
    void lcd_tmc_sg_result() {
      ...
      #endif
      #if AXIS_HAS_STALLGUARD(Z3) && !AXIS_DRIVER_TYPE(Z3, TMC2660)
        TMC_SHOW_SG_RESULT(Z3);
      #endif
      ...
      #endif
      #if AXIS_HAS_STALLGUARD(E5) && !AXIS_DRIVER_TYPE(E5, TMC2660)
        TMC_SHOW_SG_RESULT(E5);
      #endif
      END_MENU();
    }
