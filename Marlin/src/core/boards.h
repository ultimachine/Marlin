...
#define BOARD_FEYNMANLIGHT            3025  // UltiMachine FeynmanLight
#define BOARD_ALLIGATOR               3026  // Alligator Board R2
#define BOARD_CNCONTROLS_15D          3027  // Cartesio CN Controls V15 on DUE
