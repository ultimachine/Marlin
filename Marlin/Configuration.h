...
#define TEMP_BED_WINDOW_COOL 0.75    // (degC) Window around target to start the cooling residency timer x degC early.
...
#define THERMAL_RUNAWAY_PROTECTION_PERIOD 15 //in seconds
