 ...
 *
 *   -56 : thermocouple with MAX31856+ (only for sensors 0-2,BED,CHAMBER)
...
#define HEATER_0_MINTEMP   -1000
#define HEATER_1_MINTEMP   -1000
#define HEATER_2_MINTEMP   -1000
#define HEATER_3_MINTEMP   5
#define HEATER_4_MINTEMP   5
#define HEATER_5_MINTEMP   5
#define HEATER_6_MINTEMP   5
#define HEATER_7_MINTEMP   5
#define BED_MINTEMP        -1000

// Above this temperature the heater will be switched off.
// This can protect components from overheating, but NOT from shorts and failures.
// (Use MINTEMP for thermistor short/failure protection.)
#define HEATER_0_MAXTEMP 2000
#define HEATER_1_MAXTEMP 2000
#define HEATER_2_MAXTEMP 2000
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 25, 10000 }
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  //New Screen defines from Ultimachine
  #define NEWPANEL
  #define ULTRA_LCD
