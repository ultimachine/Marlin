...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_FEYNMAN_JUMPER
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "MFMENDEL"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // MFMENDEL with Makergear hotend@12V
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 712 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 50, 50, 2.5, 25 }
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    6 //CAB_LED PA1 // LED driving pin on motherboard
  #define NEOPIXEL_PIXELS 24       // Number of LEDs on strip
