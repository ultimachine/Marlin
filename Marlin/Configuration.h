...
//#define Z_PROBE_END_SCRIPT "G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10" // These commands will be executed in the end of G29 routine.
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with Z probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 200)    // X point for Z homing when homing all axis (G28).
    #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 90)    // Y point for Z homing when homing all axis (G28).
...
//#define HOMING_FEEDRATE {50*60, 50*60, 12*60, 0}  // set the homing speeds (mm/min)
#define HOMING_FEEDRATE {30*60, 30*60, 3.3*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.50 ,100.50 ,1600.00,833.00}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,500}  // default steps per unit for Ultimaker
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {133, 133, 3.3, 40}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
